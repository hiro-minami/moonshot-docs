...
- [ADR 001: フロントエンドへの Feature-Sliced Design の採用](../adr/001-frontend-feature-sliced-design/)
- [ADR 002: Hono と Clean Architecture (手動DI) の採用](../adr/002-hono-clean-architecture/)
- [ADR 003: インフラストラクチャの AWS 一元管理 (ECS Fargate + Aurora)](../adr/003-aws-ecs-aurora/)
- [ADR 004: Clerk による認証基盤の採用](../adr/004-clerk-auth/)
- [ADR 005: TanStack Query による状態管理と楽観的UI](../adr/005-tanstack-query/)
- [ADR 006: shadcn/ui + Tailwind CSS v4 によるUI基盤](../adr/006-shadcn-ui/)
- [ADR 007: ユーザーID設計と Clerk → Aurora 同期方式](../adr/007-user-id-sync/)
- [ADR 008: 論理削除戦略 (Read 時カスケード)](../adr/008-soft-delete/)
- [ADR 009: Idempotency-Key の保存先 (UNLOGGED TABLE)](../adr/009-idempotency-key/)
- [ADR 010: デザイントークンと CSS 変数を用いたテーマ管理](../adr/010-design-tokens/)
- [ADR 013: 破壊的操作における Undo トーストパターンの採用](../adr/013-undo-toast-pattern/)
- [ADR 014: Hono RPC クライアントによる型安全な API 呼び出し](../adr/014-hono-rpc-client/)
- [ADR 015: View Transitions API によるページ遷移アニメーション](../adr/015-view-transitions/)
